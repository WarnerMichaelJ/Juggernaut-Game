...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Phrases; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Phrases =\n/*#__PURE__*/\nfunction () {\n  function Phrases() {\n    _classCallCheck(this, Phrases);\n\n    this.sentences = [\"yeah it's the juggernaut!\", \"slow motion for me\", \"I miss NBA Jam\", \"I like it like that\", \"smash that wall\", \"type this type this\", \"no one asks, hey how's the juggernaut?\", \"smash smash smash\", \"you think this is a game?\", \"was I in deadpool 2\", \"yeah it's the juggernaut, bricks!\", \"I'm a dumb guy, my world view is limited\", \"I got my helmet back!\", \"this is a long street\", \"why does this road have walls\", \"most intense jog ever\", \"damn I hate cardio\", \"no peripheral vision damn helmet\", \"I don't remember why I hate walls so much\"];\n    this.successfulSentences = [\"GuEsS sMaShInG's BaCk oN tHe MeNu bOyS!\", \"YOU'RE A TYPING BEAST\", \"How are you so good at this =O\", \"whoa you type really fast!\", \"Teach me your typing ways\", \"READING IS FUN\", \"LoOk aT yOu gO!!\", \"I could type too if my fingers weren't so MEATY\"];\n  }\n\n  _createClass(Phrases, [{\n    key: \"samplePositivity\",\n    value: function samplePositivity() {\n      return this.successfulSentences[Math.floor(Math.random() * this.successfulSentences.length)];\n    }\n  }, {\n    key: \"sample\",\n    value: function sample() {\n      return this.sentences[Math.floor(Math.random() * this.sentences.length)];\n    }\n  }]);\n\n  return Phrases;\n}();\n\n\n\n//# sourceURL=webpack:///./src/phrases.js?");
